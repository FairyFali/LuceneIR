...
//巡查举报操作
// by speed
function user_report(tid) {
    //alert(jQuery(this).attr('onclick'));
    var show_tip = arguments[1] ? arguments[1] : false;    
    jQuery('#user_report_'+tid).unbind("click");
    //alert(jQuery(this).attr('onclick'));
    var url = '/plugin.php?id=patrol:user_report';
    jQuery.ajax({
        type : 'POST',
        url : url,
        dataType : 'json',
        ...
        success: function(data){
            if (data.code==1) {
                jQuery('#normalthread_'+tid).hide(600);
                jQuery('#stickthread_'+tid).hide(600);
                if (show_tip) {
                    art.dialog({
                        time : 3,
                        icon: 'succeed',
                        content: data.msg+' 3秒后关闭...'
                    });
                }
            } else {
                art.dialog({
                ...
                jQuery('#user_report_'+tid).click(function(){
                    user_report(tid);
                });
            }
        },
