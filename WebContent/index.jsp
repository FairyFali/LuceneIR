...
<body>
	<%-- <c:forEach items="${wangyiHotNews}" var="news">
		<span><a href="${news.docURL }">${news.title}_${news.category }</a></span><br/>
	</c:forEach> --%>
	<!-- Content -->
	<div class="cd-hero">
		<!-- Navigation -->
			...
			<nav class="navbar">
				<div class="tm-navbar-bg">
					<a class="navbar-brand text-uppercase"
						style="color: #337ab7; font-weight: bold; font-size: 25px; font-style: italic;"
						href="#">EveryNews <span style="color: black">新闻搜索</span></a>
					...
					<div
						...
						<ul class="nav navbar-nav">
							<li class="nav-item active selected"><a class="nav-link"
								href="index.jsp" data-no="1">搜索<span class="sr-only">(current)</span></a>
							</li>
		...
		<ul class="cd-hero-slider">
			...
			<li class="selected">
				<div class="cd-full-width">
					<div class="container-fluid  tm-contact-page tm-page-1"
						data-page-no="1">
							...
							<div class="col-xs-12">
								<div class="tm-flex tm-contact-container">
									<div
										...
										<p class="tm-text">EveryNews信息检索系统是一款多功能新闻搜索引擎，支持关键词检索及通配符检索，具备分类检索，关键词高亮，热度排序等功能。</p>
										<!-- contact form -->
										<form action="search" method="get" class="tm-contact-form">
											<div class="form-group">
												<input type="text" id="contact_subject query" type="text"
													name="query" class="form-control" placeholder="请输入关键字"
													required />
											</div>
							...
							<div class="tm-img-gallery gallery-one">
								...
								<c:forEach items="${wangyiHotNews }" var="n">
									<div class="grid-item" style="width: 320px; height: 300px; border: 10px solid #ffffff; padding: 20px; background: white; color: black; margin: 10px;">
										<h3 class="tm-text-title tm-gallery-title">
											<span class="tm-black">${n.title }</span>
										</h3>
										<a href="${n.docURL}">${fn:length(n.content) > 100?fn:substring(n.content, 0, 100):n.content}</a>
									</div>
								</c:forEach>
							</div>
						</div>
		...
		<footer class="tm-footer">
			...
			<p class="tm-copyright-text" style="float: right;">
				<i>Design & Power by</i> <a href="http://fairyfali.github.io"
					style="font-weight: bold; color: white;">王发利</a> 孔哲 刘锦 &copy;
				2019
			</p>
		</footer>
	</div>
